...
static unsigned int baralpha        = 0xdd; // 0xd0
...
static const char *yasscmd[]   = { "bash", "/home/xrc2/.screenshot.sh", NULL };
static const char *incVolume[] = { "amixer", "-D", "pulse", "set", "Master", "5%+", NULL };
static const char *decVolume[] = { "amixer", "-D", "pulse", "set", "Master", "5%-", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_s,	   		 spawn,	   	 {.v = yasscmd } },
